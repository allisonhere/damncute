...
if (!function_exists('damncute_pet_grid_shortcode')) {
    function damncute_pet_grid_shortcode($atts): string
    {
        ...
        // Handle filter params from URL if present
        $tax_query = [];
        ...
        // Infinite Scroll Loader (always included for main grid)
        if ($a['pagination'] === 'true') {
            ...
            // Standard Pagination (Hidden by JS but good for SEO)
            $big = 999999999;
...
if (!function_exists('damncute_pet_social_shortcode')) {
    function damncute_pet_social_shortcode(): string
    {
        ...
        $comment_label = ($comment_count > 0) ? sprintf(__('Discussion (%d)', 'damncute'), $comment_count) : __('Start Discussion', 'damncute');
...
if (!function_exists('damncute_hearts_only_shortcode')) {
    function damncute_hearts_only_shortcode(): string {
        ...
        return '<span class="dc-card-hearts">❤️ 999 TEST</span>';
